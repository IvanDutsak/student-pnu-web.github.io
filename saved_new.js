    ...
    if (savedRatings.length === 0) {
        ...
        savedRatings.forEach((rating, index) => {
            ...
            item.innerHTML = `
                ...
                <div class="button-group">
                    <button class="control-btn load-btn" onclick="showRatingDetails(${index})">
                        <i class="fas fa-eye"></i> Деталі
                    </button>
                    <button class="control-btn warning edit-btn" onclick="editRating(${index})">
...
function showRatingDetails(index) {
    ...
    window.location.href = 'rating-details.html'; // Змінено посилання на rating-details_new.html
}
...
function showScheduleDetails(key) {
    ...
    if (scheduleData) {
        ...
        window.location.href = 'schedule-details.html'; // Змінено посилання на schedule-details_new.html
    } else {
...
function editRating(index) {
    ...
    window.location.href = 'rating_new.html?edit=true'; // Змінено посилання на rating_new.html
}
